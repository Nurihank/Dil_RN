...
export default function DilSeçimModal({ visible, DilModalGeriTusu, DilSecimiOnayi }) {
  ...
  const GetAllDiller = async () => {
    try {
      ...
      setDiller(response.data.result); // dİLLERİ state'e set et
    } catch (error) {
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity onPress={DilModalGeriTusu} style={styles.button}>
